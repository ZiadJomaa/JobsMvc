        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyProfiles_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobSeekerProfiles_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobSeekerProfiles_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                name: "CompanyProfileCities",
                columns: table => new
                {
                    CompanyProfileId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CityId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyProfileCities", x => new { x.CompanyProfileId, x.CityId });
                    table.ForeignKey(
                        name: "FK_CompanyProfileCities_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyProfileCities_CompanyProfiles_CompanyProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JobSeekerProfileId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resumes_JobSeekerProfiles_JobSeekerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HrPrivateNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AiTermScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    JobSeekerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfileCities_CityId",
                table: "CompanyProfileCities",
                column: "CityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobSeekerProfiles_CityId",
